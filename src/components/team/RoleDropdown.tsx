...
const RoleDropdown: React.FC<RoleDropdownProps> = ({ role, roles, onRoleChange, disabled = false }) => {
  ...
  return (
    <div className="relative">
      <button
        ...
        className={`px-4 py-2 bg-secondary-50 text-secondary rounded-lg flex items-center justify-between w-full ${
          ...
          {roles.map((roleOption) => (
            ...
            >
              <div className={`w-5 h-5 rounded border ${
                role === roleOption ? 'border-secondary bg-secondary' : 'border-gray-300'
