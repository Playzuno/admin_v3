...
const StatsCard: React.FC<StatsCardProps> = ({
  ...
  return (
    <div
      className={`bg-white rounded-2xl p-6 border transition-colors duration-200 hover:border-primary ${
        ...
        <div className="space-y-1">
          <div className="flex justify-between items-start gap-8">
            <div>
              ...
              <p className="text-2xs text-secondary text-nowrap">{subtext}</p>
            </div>
            <div>
