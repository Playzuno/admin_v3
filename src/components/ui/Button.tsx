...
type ButtonVariant = 'primary' | 'secondary' | 'outline' | 'ghost' | 'danger' | 'light' | 'error';
...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles = 'inline-flex items-center justify-center font-medium transition-colors duration-200 rounded-[32px] focus:outline-none focus:ring-2 focus:ring-offset-2';

  const variantStyles: Record<ButtonVariant, string> = {
    primary: 'bg-[#400C7A] text-white hover:bg-[#330962] focus:ring-[#400C7A]/50',
